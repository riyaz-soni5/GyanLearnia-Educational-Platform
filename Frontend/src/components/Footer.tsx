      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-6 text-muted">
              The Ultimate Learning and Teaching Platform.
            </p>
          </div>

          <div>
            <h3 className="text-sm font-semibold text-basec">Quick Link</h3>
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li>
                <Link to="/mentors" className="text-muted hover:text-basec">
                  Find a Tutor
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-muted hover:text-basec">
                  About
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li>
                <Link to="/about#contact" className="text-muted hover:text-basec">
                  Contact
                </Link>
              </li>
              <li>
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-base pt-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-4 text-sm">
            <a href="mailto:support@gyanlearnia.com" className="text-muted hover:text-basec">
