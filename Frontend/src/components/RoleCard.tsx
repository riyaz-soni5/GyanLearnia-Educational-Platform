...
function RoleCard({ to, label }: { to: string; label: string }) {
  return (
    <Link
      to={to}
      className="group flex w-full items-center justify-between rounded-xl border border-indigo-200 bg-indigo-50 px-6 py-5 text-left transition hover:bg-indigo-100 dark:border-indigo-800 dark:bg-indigo-950/40 dark:hover:bg-indigo-900/40"
    >
